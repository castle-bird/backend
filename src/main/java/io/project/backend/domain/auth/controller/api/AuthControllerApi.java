...
public interface AuthControllerApi {
  ...
  @Operation(summary = "사용자등록", description = "사용자를 등록하고 아이디/임시비번을 발급 받습니다.")
  @ApiResponses({
  ...
  ResponseEntity<CommonApiResponse<SignupResponse>> createEmployee(SignupRequest signupRequest);
  ...
  ResponseEntity<CommonApiResponse<LoginResponse>> login(LoginRequest loginRequest);
