...
public interface AuthControllerApi {
  ...
  @ApiResponses({
      ...
      @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "409", description = "중복된 이메일", content = @Content)
  })
  ResponseEntity<ApiResponse<AuthResponse>> signup(SignupRequest signupRequest);
  ...
  @ApiResponses({
      ...
      @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "유효하지 않은 refresh token", content = @Content)
  })
  ...
  ResponseEntity<ApiResponse<Void>> logout(UserDetailsImpl userDetails, String refreshToken);
}
